...
class AgentInfo {
  ...
  static const Map<String, AgentInfo> _map = {
    ...
    'furniture': AgentInfo(key: 'furniture_catalog', name: '家具', emoji: '🪑', color: procurementColor),
    'door_window_waterproof': AgentInfo(key: 'door_window_waterproof', name: '门窗防水', emoji: '🚪', color: constructionColor),
    'door_window': AgentInfo(key: 'door_window_waterproof', name: '门窗防水', emoji: '🚪', color: constructionColor),
