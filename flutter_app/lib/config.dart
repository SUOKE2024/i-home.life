...
class AppConfig {
  ...
  ///    `flutter build --dart-define=API_BASE_URL=https://i-home.life/api`
  /// 注意：留空时仅 Web 端可正常工作（相对路径基于页面 origin 解析）；
  ///       原生端务必通过 dart-define 注入完整绝对地址。
  /// 2026-08-08 域名切换：默认值由 http://118.31.223.213:8081/api 升级为
  /// https://i-home.life/api（IP:8081 仍兼容，但域名已接入 LE 证书）。
  static const String apiBaseUrl = String.fromEnvironment(
    'API_BASE_URL',
    defaultValue: 'https://i-home.life/api',
  );
  ...
  static const String appVersion = '1.15.10';
