...
def test_app_version_is_1_10_2():
    """app_version == 1.10.2"""
    assert get_settings().app_version == "1.10.2"


def test_mcp_server_version_is_1_10_2():
    """MCP SERVER_VERSION == 1.10.2"""
    from app.mcp.server import mcp_server
    assert mcp_server.SERVER_VERSION == "1.10.2"
...
def test_new_feature_flags_defaults():
    ...
    # P4 灰度 flag（默认关闭）
    assert s.ifc_h_ifc_extension_enabled is False
