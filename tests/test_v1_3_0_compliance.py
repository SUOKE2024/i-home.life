...
def test_app_version_is_1_14_0():
    """app_version == 1.14.0"""
    assert get_settings().app_version == "1.14.0"


def test_mcp_server_version_is_1_14_0():
    """MCP SERVER_VERSION == 1.14.0"""
    from app.mcp.server import mcp_server
    assert mcp_server.SERVER_VERSION == "1.14.0"
