...
ROOM_DEVICE_PRESETS: dict[str, list[dict]] = {
    "living_room": [
        {"device_type": "light", "device_name": "智能客厅主灯", "brand": "yeelight", "price": 880.0, "power_w": 36.0, "control_mode": "voice", "wiring_required": True, "wiring_spec": {"零火线": True}, "features": {"调光": True, "色温": True}},
        {"device_type": "switch", "device_name": "智能客厅开关", "brand": "aqara", "price": 280.0, "power_w": 0.0, "control_mode": "voice", "wiring_required": True, "wiring_spec": {"零火线": True}, "features": {"双控": True}},
        {"device_type": "curtain", "device_name": "智能客厅窗帘", "brand": "dooya", "price": 1280.0, "power_w": 35.0, "control_mode": "voice", "wiring_required": True, "wiring_spec": {"电源预留": True}, "features": {"电动": True}},
        {"device_type": "speaker", "device_name": "智能音箱", "brand": "xiaomi", "price": 599.0, "power_w": 12.0, "control_mode": "voice", "wiring_required": False, "wiring_spec": None, "features": {"语音助手": True}},
        {"device_type": "sensor", "device_name": "红外人体传感器", "brand": "aqara", "price": 159.0, "power_w": 0.0, "control_mode": "automation", "wiring_required": False, "wiring_spec": None, "features": {"人体感应": True}},
        {"device_type": "camera", "device_name": "智能摄像头", "brand": "xiaomi", "price": 358.0, "power_w": 6.0, "control_mode": "app", "wiring_required": True, "wiring_spec": {"网线": True, "电源预留": True}, "features": {"2K": True, "夜视": True}},
    ],
    "bedroom": [
        {"device_type": "light", "device_name": "智能卧室灯", "brand": "yeelight", "price": 580.0, "power_w": 24.0, "control_mode": "voice", "wiring_required": True, "wiring_spec": {"零火线": True}, "features": {"调光": True, "助眠": True}},
        {"device_type": "switch", "device_name": "智能卧室开关", "brand": "aqara", "price": 280.0, "power_w": 0.0, "control_mode": "voice", "wiring_required": True, "wiring_spec": {"零火线": True}, "features": {"双控": True}},
        {"device_type": "curtain", "device_name": "智能卧室窗帘", "brand": "dooya", "price": 1180.0, "power_w": 35.0, "control_mode": "voice", "wiring_required": True, "wiring_spec": {"电源预留": True}, "features": {"电动": True}},
        {"device_type": "sensor", "device_name": "温湿度传感器", "brand": "aqara", "price": 129.0, "power_w": 0.0, "control_mode": "automation", "wiring_required": False, "wiring_spec": None, "features": {"温度": True, "湿度": True}},
        {"device_type": "socket", "device_name": "智能插座", "brand": "xiaomi", "price": 79.0, "power_w": 0.0, "control_mode": "app", "wiring_required": False, "wiring_spec": None, "features": {"定时": True, "电量统计": True}},
    ],
    "kitchen": [
        {"device_type": "sensor", "device_name": "烟雾传感器", "brand": "aqara", "price": 199.0, "power_w": 0.0, "control_mode": "automation", "wiring_required": False, "wiring_spec": None, "features": {"烟雾报警": True}},
        {"device_type": "sensor", "device_name": "燃气传感器", "brand": "aqara", "price": 219.0, "power_w": 0.0, "control_mode": "automation", "wiring_required": False, "wiring_spec": None, "features": {"燃气报警": True}},
        {"device_type": "socket", "device_name": "智能厨房插座", "brand": "xiaomi", "price": 89.0, "power_w": 0.0, "control_mode": "app", "wiring_required": False, "wiring_spec": None, "features": {"定时": True}},
        {"device_type": "light", "device_name": "智能厨房灯", "brand": "yeelight", "price": 380.0, "power_w": 18.0, "control_mode": "voice", "wiring_required": True, "wiring_spec": {"零火线": True}, "features": {"防油污": True}},
    ],
    "bathroom": [
        {"device_type": "sensor", "device_name": "人体传感器", "brand": "aqara", "price": 159.0, "power_w": 0.0, "control_mode": "automation", "wiring_required": False, "wiring_spec": None, "features": {"人体感应": True}},
        {"device_type": "light", "device_name": "智能卫生间灯", "brand": "yeelight", "price": 280.0, "power_w": 12.0, "control_mode": "automation", "wiring_required": True, "wiring_spec": {"零火线": True}, "features": {"防水": True}},
        {"device_type": "light", "device_name": "智能镜前灯", "brand": "yeelight", "price": 380.0, "power_w": 14.0, "control_mode": "voice", "wiring_required": True, "wiring_spec": {"零火线": True}, "features": {"防雾": True, "调光": True}},
    ],
    "entrance": [
        {"device_type": "lock", "device_name": "智能门锁", "brand": "aqara", "price": 1980.0, "power_w": 0.0, "control_mode": "app", "wiring_required": False, "wiring_spec": None, "features": {"指纹": True, "人脸": True, "密码": True}},
        {"device_type": "sensor", "device_name": "人体传感器", "brand": "aqara", "price": 159.0, "power_w": 0.0, "control_mode": "automation", "wiring_required": False, "wiring_spec": None, "features": {"人体感应": True}},
        {"device_type": "light", "device_name": "智能玄关灯", "brand": "yeelight", "price": 280.0, "power_w": 12.0, "control_mode": "automation", "wiring_required": True, "wiring_spec": {"零火线": True}, "features": {"感应亮灯": True}},
        {"device_type": "switch", "device_name": "智能玄关开关", "brand": "aqara", "price": 280.0, "power_w": 0.0, "control_mode": "voice", "wiring_required": True, "wiring_spec": {"零火线": True}, "features": {"双控": True}},
    ],
}
