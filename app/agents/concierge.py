...
FAQ_KNOWLEDGE_BASE = [
    ...
    },
    {
        ...
        "answer": "水电改造注意：1) 水管打压测试 0.8MPa 保压 30 分钟不掉压；2) 强弱电间距 ≥ 500mm 避免干扰；3) 线管横平竖直，无三管交叉；4) 开关插座位置符合图纸，偏差 ≤ 5mm；5) 水电完工验收合格后方可封槽。",
        "category": "construction",
    },
    {
        "id": "faq_004",
        ...
        "answer": "防水合格标准：1) 卫生间墙面防水高度 ≥ 1.8m，厨房 ≥ 0.3m；2) 闭水试验蓄水 48 小时无渗漏；3) 防水层涂刷至少 2-3 遍，厚度 ≥ 1.5mm；4) 阴阳角、管根处需做附加层处理。",
        "category": "construction",
    },
    {
        "id": "faq_005",
    ...
    },
    {
        ...
        "answer": "主流装修风格：1) 现代简约：简洁线条、中性色调，适合小户型；2) 北欧风：温暖木材、柔和色彩，性价比高；3) 日式侘寂：原木、白墙、留白艺术；4) 轻奢风：金属点缀、大理石、深色系；5) 新中式：传统元素与现代结合。建议根据户型和个人喜好选择。",
        "category": "design",
    },
    {
        "id": "faq_009",
        ...
        "answer": "装修验收依据国标：1) GB 50210-2018 建筑装饰装修工程质量验收标准；2) GB 50327-2017 住宅装饰装修工程施工规范；3) GB 50300-2013 建筑工程施工质量验收统一标准。分项验收包含水电、泥瓦、木工、油漆、安装五个阶段，合格率 ≥ 85% 方为合格。",
        "category": "qa",
    },
    {
        "id": "faq_010",
